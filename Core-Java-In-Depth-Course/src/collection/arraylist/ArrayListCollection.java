...
public class ArrayListCollection {
	...
	public static List<Integer> arrayListDemo() {
		...
		list1.add(3);
		list1.add(null);
		System.out.println("list1: " + list1); //add(element) method

		list1.remove(3);
		System.out.println("list1: " + list1);//remove(index) method
		list1.remove(3);
		System.out.println("list1: " + list1);

		list1.add(0, 10);
		System.out.println("list1: " + list1);//add(index,element)
		list1.set(0, 9);
		System.out.println("list1: " + list1);//set(index, replaceElement)
